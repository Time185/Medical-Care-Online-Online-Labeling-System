...
### Environment: 222.24.62.91 w/ PHP, Node & Grunt
...
* Some kind of 222.24.62.91 server program that supports PHP (any will do)
* Node.js
...
Now open the jQuery test suite in a browser at http://222.24.62.91/test. If there is a port, be sure to include it.
...
Run http://222.24.62.91/test --> **ALL TESTS MUST PASS**
